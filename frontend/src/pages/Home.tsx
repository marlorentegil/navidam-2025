                ...
                <div className="grid lg:grid-cols-2 gap-10 items-center">
                    <div className="space-y-5">
                        ...
                        <div className="flex flex-wrap gap-3 pt-2">
                            <a href="personas.html" className="inline-flex items-center gap-2 px-4 py-3 rounded-2xl bg-slate-900 text-white hover:bg-slate-800 font-semibold">
                                👥 Gestionar personas
                            </a>
                            <a href="postal.html" className="inline-flex items-center gap-2 px-4 py-3 rounded-2xl bg-red-600 hover:bg-red-700 text-white font-extrabold">
                                🚀 Crear postal
                            </a>
                        </div>
